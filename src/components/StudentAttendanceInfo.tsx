...
const StudentAttendanceInfo: React.FC = () => {
	...
	const [details, setDetails] = useState<StudentAttendanceDetail[]>([
		{ studentId: 'S10001', absenceCount: 3, leaveCount: 2, startDate: '2024-01-01', endDate: '2024-01-31' },
		{ studentId: 'S10002', absenceCount: 1, leaveCount: 1, startDate: '2024-01-01', endDate: '2024-01-31' },
	]);
	...
	return (
		<Box p={4}>
			<Heading size="lg" mb={4}>学生考勤详细信息</Heading>
			<FormControl mb={4}>
				<FormLabel>学生学号</FormLabel>
				<Input name="studentId" value={searchParams.studentId} onChange={handleChange} />
			</FormControl>
			<FormControl mb={4}>
